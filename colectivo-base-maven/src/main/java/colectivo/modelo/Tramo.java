...
/**
 * Representa un tramo de conexión entre dos paradas.
 * Un tramo puede ser de diferentes tipos (transporte público o caminando),
 * conecta una parada de inicio con una de fin, y tiene un tiempo de duración asociado.
 * Si el tramo es del tipo CAMINANDO, automáticamente registra la conexión bidireccional
 * entre las paradas para permitir búsquedas con tramos a pie.
 */
public class Tramo {
